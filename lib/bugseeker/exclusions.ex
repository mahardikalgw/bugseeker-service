defmodule Bugseeker.Exclusions do
  @moduledoc """
  ...
  Pure module; configuration comes from `config :bugseeker, :exclusions`.
  """
  ...
  def filter(files) do
    max_files = Application.get_env(:bugseeker, :max_files_per_pr, 30)
    config = Application.get_env(:bugseeker, :exclusions, %{})
