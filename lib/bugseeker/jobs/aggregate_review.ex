defmodule Bugseeker.Jobs.AggregateReviewJob do
  @moduledoc """
  ...
  alias Bugseeker.{Clients, Repo, Reviews}
  alias Bugseeker.Reviews.Aggregator, as: Review
