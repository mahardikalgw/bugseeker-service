defmodule Bugseeker.Jobs.AgentJob do
  @moduledoc """
  ...
  alias Bugseeker.{Agents, Clients, Repo, Reviews}
  alias Bugseeker.Jobs.AggregateReviewJob
  alias Bugseeker.Llm.Parser
  alias Bugseeker.Llm.Prompt
  alias Bugseeker.Reviews.PrReview
  ...
  defp run_agent(pr_review, agent) do
    ...
    case Clients.llm().chat(prompt) do
      {:ok, %{content: content}} ->
        Bugseeker.Stats.record_deepseek(:ok)
