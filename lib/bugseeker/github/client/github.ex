defmodule Bugseeker.Github.Client.Github do
  @moduledoc """
  Req-based implementation of `Bugseeker.Github.Client`.

  Uses a GitHub App installation token obtained from
  `Bugseeker.Github.AppAuth` and refreshes it once on a 401.
  """

  @behaviour Bugseeker.Github.Client

  alias Bugseeker.Github.{AppAuth, Error}
  ...
  defp build_request(method, path, payload, token, opts) do
    api_url = Application.get_env(:bugseeker, :github_api_url, @api_url)
