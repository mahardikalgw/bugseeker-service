defmodule Bugseeker.Github.AppAuth do
  @moduledoc """
  ...
  @impl true
  def init(_opts) do
    path = get_in(Application.get_env(:bugseeker, :github), [:private_key_path])
    ...
    app_id = get_in(Application.get_env(:bugseeker, :github), [:app_id])
  ...
  defp fetch_installation_token(installation_id, state) do
    jwt = sign_jwt(state)
    api_url = Application.get_env(:bugseeker, :github_api_url, "https://api.github.com")
