defmodule Bugseeker.Reviews.Aggregator do
  @moduledoc """
  ...
  def aggregate(issues, patches, skipped, warnings, pr) do
    # `pr.min_inline_severity` is set from the repo's own `.bugseeker.yml`
  ...
  defp render_summary(issues, demoted, skipped, warnings, pr) do
    ...
    header =
      """
      ## 🤖 Bugseeker Review — PR ##{pr.pr_number}
